            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex place-content-end mb-4">
                        ...
                        <a href="{{ route('rate-plan-code.create') }}"> Rate Plan Code </a>
                        </div>
                    </div>
                    ...
                    <div class="overflow-hidden overflow-x-auto min-w-full align-middle sm:rounded-md">
                        <table class="min-w-full border divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 divide-solid">
                                @foreach($rate_plan_code as $rpcode)
                                <tr class="bg-white">
                                    <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                        {{ $rpcode->inventory_type_code->name }}
                                    </td>
                                    <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                        {{ $rpcode->rate_plan_code }}
                                    </td>
                                    <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                        <a href="{{ route('rate-plan-code.edit', $rpcode->id) }}">
                                        ...
                                        <form method="post" action="{{ route('rate-plan-code.destroy', $rpcode->id) }}">
                                            @method('DELETE')
