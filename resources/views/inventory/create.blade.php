<x-app-layout>
    ...
    <form class="space-y-6" action="{{ route('inventory.store') }}" method="POST" enctype="multipart/form-data" autocomplete="false">
        {{ csrf_field() }}
        <div class="space-y-4">
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="text" name="count" id="count"
                            class="block mt-1 w-1/2 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                </div>
                @if($errors->has('count'))
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="text" name="start_date" id="start_date"
                            class="block mt-1 w-1/2 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="yyyy-mm-dd">
                </div>
                ...
                success: function(result) {
                    ...
                    if(result.length) {
                        ...
                        jQuery.each(result, function(index, itemData) {
                            $('#rpcode').append('<option value="'+itemData['id']+'">'+itemData["rate_plan_code"]+'</option>');
                        });
                    }else {
                        $('#rpcode').empty();
                    }
